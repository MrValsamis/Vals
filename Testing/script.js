...
eventDates[day4a] = [
  '</br>DAY 4</br></br><u>In class:</u></br>Waves and Sound Day 3 (link)</br>Go over homework</br>Finish wave notes and answer questions</br>Speed of Sound Lab</br>Gather Data</br>Discuss and analyze results</br>If time...discuss lab report</br></br></br><u>Homework:</u></br>-Wave terms quiz next class</br>-If you would like some extra wave term review, feel free to check out this video (link)</br>-Speed of sound lab (link) (open and make a copy) due in 3 classes',
]
let day4b = formatDate(new Date(new Date().setDate(new Date().getDate() + 51)))
eventDates[day4b] = [
  '</br>DAY 4</br></br><u>In class:</u></br>Waves and Sound Day 3 (link)</br>Go over homework</br>Finish wave notes and answer questions</br>Speed of Sound Lab</br>Gather Data</br>Discuss and analyze results</br>If time...discuss lab report</br></br></br><u>Homework:</u></br>-Wave terms quiz next class</br>-If you would like some extra wave term review, feel free to check out this video (link)</br>-Speed of sound lab (link) (open and make a copy) due in 3 classes',
]
